...
@alia.on_message(filters.command("weebify"))
...
@alia.on_message(filters.command("bubble"))
...
@alia.on_message(filters.command("fbubble"))
...
@alia.on_message(filters.command("square"))
...
@alia.on_message(filters.command("fsquare"))
...
@alia.on_message(filters.command("blue"))
...
@alia.on_message(filters.command("latin"))
...
@alia.on_message(filters.command("lined"))
