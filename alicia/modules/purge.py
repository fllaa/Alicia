...
from alicia import LOGGER, alia, bot_id


@alia.on_message(filters.command("purge"))
async def purge(client, message):
    ...
    if message.reply_to_message:
        ...
        if bot_rights:
            ...
            del_msg = await client.send_message(chat.id, "Purge complete.")
            time.sleep(2)
...
@alia.on_message(filters.command("del"))
